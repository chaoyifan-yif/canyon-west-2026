...
const MEALS = {
  ...
  'd4-15':{kind:'晚餐',context:'按原计划21:00才进 Flagstaff Downtown，多数好店可能已停止接单。饭后夜逛与拍星二选一；此时只能以高处银河星带、星野或星轨为目标，不能按早场银心攻略执行。拍星走 US-180 的 Peak View，不绕行施工中的 Sunset Crater 南入口。',options:[
...
const STARS = {
  3:{title:'Page · 早场低银心 / 晚场银河星带',place:'Wahweap Overlook · 以当晚标识开放为准',address:'Wahweap Overlook, US-89, Page, AZ 86040',distance:'从 Home2 约10–15分钟车程（规划估算）',window:'10/5 早场19:25–20:00 或原定晚场20:15–21:15 MST',moon:'月亮约15:29落下，次日约02:07才升起；晚间基本无月光。',reality:'Page 18:03日落、约19:28天文暮光结束。按天体位置估算，19:30银心在西南约17°，20:30约9°；并非高悬，能否出片看西南地平线、云和灯光。原定晚餐18:25–19:45与早场冲突：若特别想要银心，需改晚餐/外带；保持原行程则拍天鹅座星带、夏季大三角和星野。',subjects:[['A · 早场低银心','仅在自愿挪动晚餐且现场西南方无遮挡时尝试；19:25前就位，20点后会越来越低。'],['B · 晚场银河星带','原行程不改：找天鹅座 / 夏季大三角，避开镇灯方向，拍银河高处与地景。'],['C · 北天星轨','北向固定三脚架连拍，星轨不是单张长曝，也无需看到银心。']],plan:['17:30左右看云量、风与官方开放信息。早场银心需跳过或提前吃 Big John’s 晚餐；不改变订好的羚羊谷16:00场。','导航到 NPS Wahweap Overlook 正式停车区；不要与日落后关闭的 Wahweap View / Sunrise Point 混淆。停车后先确认标识，若封闭直接取消。','早场约19:10–19:20到位找西南低空；原行程晚场约20:15出发拍高处星带。用星图确认当天方位，绝不为了低空银心走向崖边。','拍20–40分钟即回。若云、风或次日体力不合适，宁可不拍；16mm仍可在 Flagstaff 另拍星野。'],camera:'尼康 Z5 + 唯卓仕16mm：M档、RAW、f/1.8、10–15秒、ISO1600–3200起步；三脚架固定时将VR关掉，手动放大亮星精确对焦并拍一张100%检查边角星点。20秒不保证无拖线，先试10秒；白平衡约3800–4300K只是预览起点，RAW可后调。',workflow:'想降噪可先拍8–15张相同构图与参数的RAW；间隔须大于快门时间加上机身处理与延迟，先试拍2张确认不漏帧。后期先统一处理，再用支持星空对齐与地景蒙版的软件堆栈；水面会变化，倒影不能按静止地景冻结。',safety:'Glen Canyon 并非每个观景停车点都全天开放；以当晚标识及公告为准。只在指定停车区，不临崖、不驶入不明岔道；红光头灯、保暖、结伴，风大就回酒店。',sources:['https://home.nps.gov/places/wahweap-overlook.htm','https://www.timeanddate.com/sun/usa/page?month=10','https://www.timeanddate.com/moon/usa/page?month=10','https://www.chandra.harvard.edu/photo/2026/sgrawind/index.html','https://aa.usno.navy.mil/faq/GAST','https://onlinemanual.nikonimglib.com/z5/en/09_menu_guide_03_31.html']},
  4:{title:'Flagstaff · 日落后拍星，不误南缘',place:'Peak View Overlook · US-180 正式停车区',address:'Peak View Overlook, US-180, Flagstaff, AZ',distance:'从 Fairfield East 约25–35分钟车程（规划估算）',window:'原行程10/6约22:10–22:55 MST；银心早场需19:25前到机位，和南缘日落冲突',moon:'月亮约15:58落下，次日约02:11再升起；晚间基本无月光。',reality:'文档的“19:30银心高70–80°”是错误的：以 NASA 星心坐标和 USNO 恒星时估算，Flagstaff 19:30约18°、20:30约10°，约21:35到几何地平线；山脊与大气会让它更早消失。天文暮光约19:27结束确实对。现有行程18:04在南缘看日落、20:20才到酒店，不可能18:45到 Lake Mary。保留南缘日落就按晚场拍高处银河星带/山影/星轨，不宣称拍到银心。',subjects:[['A · 原行程晚场','Peak View 的正式停车区拍天鹅座银河星带、北天星轨与 San Francisco Peaks 山影。'],['B · 银心早场（改行程）','只有主动放弃南缘日落并大幅提前离园，且当天证实机位开放、无遮挡，才考虑19:25前就位。'],['C · Lake Mary 候选','可在白天实地踏勘后另选合法停车点；市政府近期报告 Upper Lake Mary 仅约16%蓄水，不能保证水面倒影。']],plan:['保留原计划：18:04在大峡谷南缘看日落，约20:20到 Fairfield East；先吃饭，若有体力才去 US-180 Peak View。银心早场不是这条路线的隐藏加项。','沿铺装 US-180 到 Peak View 官方停车区；到场约22:10以后用星图找高处银河星带，先拍10–15秒单张，再试8–15张堆栈或北向短星轨；停留30–45分钟。','若特别想拍银心，需在出发前重排10/6大峡谷行程、放弃南缘日落；Lake Mary 不设为自动导航目的地。白天先核对合法停车、夜间出入、湖水和西南地平线。','天气差、司机疲劳或已经很晚就回酒店；今晚不绕去 Sunset Crater，其常用南侧入口道路在9/21–10/21施工关闭。'],camera:'尼康 Z5 + 唯卓仕16mm：M档、RAW、f/1.8、10–15秒、ISO1600–3200起步；三脚架固定时关VR。MF放大亮星到最小点，试拍后100%查看中央与边角，若拖线先缩到8–10秒，若边角彗差明显可试f/2–2.2。3850K不是“必须”，RAW可后调；对焦被碰或温度大变要复查。',workflow:'拍单张先成功，再堆栈：同参数连拍8–15张；Z5间隔拍摄要把曝光、可选d4延迟、写卡/处理都算进去，15秒曝光先试19–22秒间隔并检查没有漏张，切忌把“曝光+2秒”当保证。多张对齐星点后要单独处理不移动的地景；星轨应连续拍20–30分钟再叠加。Long Exposure NR在连拍堆栈时可关以避免等待，单张时可按需求开启。',safety:'Peak View 夜间是否临时关闭未核实；看公告与入口标识，封闭就不进。Lake Mary 的无名路肩和 Two Guns 荒地未核实合法停车与夜间通行，不能当默认安全机位。US-180 夜间注意野生动物与低温，合法使用远光灯，遇对向车500英尺内或跟车200英尺内切近光；保暖、红光灯、结伴，不走进无灯树林。',sources:['https://www.timeanddate.com/sun/usa/flagstaff?month=10','https://www.timeanddate.com/moon/usa/flagstaff?month=10','https://www.chandra.harvard.edu/photo/2026/sgrawind/index.html','https://aa.usno.navy.mil/faq/GAST','https://www.flagstaff.az.gov/1275/Water-Services','https://www.flagstaffarizona.org/things-to-do/outdoors-nature/winter-adventure/','https://www.nps.gov/sucr/learn/news/2026-08-24-fs-545-road-closure.htm','https://www.azleg.gov/ars/28/00942.htm','https://onlinemanual.nikonimglib.com/z5/en/09_menu_guide_03_31.html']}
};
